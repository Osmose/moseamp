...
//		       	ao_song_done = 1;
  ...
  // wanna have around 1/60 sec (16.666 ms) updates
	if ((((unsigned char *)pS2)-((unsigned char *)pSpuBuffer)) == (735*4))
	{
	    	ps2_update((u8*)pSpuBuffer,(u8*)pS2-(u8*)pSpuBuffer);
	        pS2=(short *)pSpuBuffer;
	}
 }
...
static void SetupTimer(void)
{
 ...
 pS2=(short *)pSpuBuffer;                               // setup soundbuffer pointer
